...
class YearBy:
    ...
    def __init__(self):
        ...
        Label(self.screen, text='Year By Year Calculator', fg=settings.WHITE, bg=settings.BLACK, font=settings.title_font) \
        ...
        self.ending_capital_disp = Text(
            self.screen, width=20, height=1, wrap=WORD, background=settings.WHITE, font=settings.entry_font)
